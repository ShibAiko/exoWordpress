...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221207_sitetest_ff7375b8ed6d544e1320_20221207130555_archive.zip';
        const ARCHIVE_SIZE       = '38084911';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'ff7375b-07130555';
        const SECONDARY_PACKAGE_HASH = 'fbe6872-07130555';
        const VERSION            = '1.5.1';
